...
#define UART1_RX_BUFFER_SIZE 1024 /**< Tama�o del buffer circular de recepci�n. Debe ser potencia de 2. */
#define UART2_RX_BUFFER_SIZE 64 /**< Tama�o del buffer circular de recepci�n. Debe ser potencia de 2. */
